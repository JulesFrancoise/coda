...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("codemirror"), require("codemirror/addon/search/searchcursor"), require("codemirror/addon/edit/matchbrackets"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["codemirror", "codemirror/addon/search/searchcursor", "codemirror/addon/edit/matchbrackets"], mod);
  ...
  cmds.selectLinesUpward = function(cm) {
    cm.operation(function() {
      ...
      if (range.head.line > cm.firstLine()) {
        cm.setSelection(Pos(0, 0), Pos(range.head.line, range.head.ch));
      }
    });
  };
  cmds.selectLinesDownward = function(cm) {
    cm.operation(function() {
      ...
      if (range.head.line > cm.firstLine()) {
        cm.setSelection(
          Pos(range.head.line, range.head.ch),
          Pos(cm.lineCount(), 0),
        );
      }
    });
  ...
  keyMap.macSublime = {
    ...
    "Shift-Cmd-K": "toggleCommentIndented",
    "Cmd-J": "joinLines",
    ...
    "Shift-Cmd-Up": "selectLinesUpward",
    "Shift-Cmd-Down": "selectLinesDownward",
    "Cmd-F3": "findUnder",
